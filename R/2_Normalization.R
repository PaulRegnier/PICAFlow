...
{
  # This precise package has to be loaded before the Shiny application launches because otherwise it can throw an error because it seems to be not properly loaded by Shiny itself
